 ...
 */
interface IPlayInfoManager<B: BaseAlbumItem<M, A>?, M: BaseMusicItem<A>?, A: BaseArtistItem?> {

  fun getAlbum(): B

  fun getAlbumMusics(): List<M>

  fun setChangingPlayingMusic(changingPlayingMusic: Boolean)

  fun getAlbumIndex(): Int;

  fun getRepeatMode(): Enum<PlayingInfoManager.RepeatMode>

  fun getCurrentPlayingMusic(): M
}
